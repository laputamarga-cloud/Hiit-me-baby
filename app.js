(() => {
  ...
  const EXERCISE_IMAGES = {
    ...
    'plancha-lateral': 'data:image/webp;base64,',
    'triceps-apoyo': 'data:image/webp;base64,',
  };
  ...
  const IMAGE_KEY = {
    ...
    'Puente marchado': 'puente-gluteo',
    'Plancha': 'plancha',
    'Plancha lateral derecha': 'plancha-lateral',
    'Plancha lateral izquierda': 'plancha-lateral',
    'Tríceps con apoyo': 'triceps-apoyo'
  };

  const REPDB_IMAGE_BASE = 'https://exercise-dataset.com/images/flat/';
  const EXERCISE_REMOTE_POSES = {
    'Peso muerto rumano': ['dumbbell-romanian-deadlift-start.webp', 'dumbbell-romanian-deadlift-peak.webp'],
    'Flexiones inclinadas': ['incline-push-ups-start.webp', 'incline-push-ups-peak.webp'],
    'Dead bug': ['dead-bug-start.webp', 'dead-bug-peak.webp'],
    'Press de suelo': ['dumbbell-floor-press-start.webp', 'dumbbell-floor-press-peak.webp'],
    'Curl de bíceps': ['bicep-curl-start.webp', 'bicep-curl-peak.webp'],
    'Elevaciones laterales': ['lateral-raise-start.webp', 'lateral-raise-peak.webp'],
    'Patada de glúteo derecha': ['glute-kickback-start.webp', 'glute-kickback-peak.webp'],
    'Patada de glúteo izquierda': ['glute-kickback-start.webp', 'glute-kickback-peak.webp'],
    'Elevaciones de gemelo': ['bodyweight-calf-raise-start.webp', 'bodyweight-calf-raise-peak.webp'],
    'Patada de tríceps': ['tricep-kickback-start.webp', 'tricep-kickback-peak.webp'],
    'Remo vertical': ['dumbbell-upright-row-start.webp', 'dumbbell-upright-row-peak.webp']
  };

  const EXERCISE_REMOTE_SINGLE = {
    'Shoulder taps': 'high-plank-main.webp'
  };
  ...
  function embeddedImageForExercise(name) {
    const key = IMAGE_KEY[name];
    return key ? EXERCISE_IMAGES[key] : null;
  }

  function remotePoseUrls(name) {
    const pair = EXERCISE_REMOTE_POSES[name];
    return pair ? pair.map((file) => `${REPDB_IMAGE_BASE}${file}`) : null;
  }

  function remoteSingleUrl(name) {
    const file = EXERCISE_REMOTE_SINGLE[name];
    return file ? `${REPDB_IMAGE_BASE}${file}` : null;
  }

  function hasVisual(name) {
    return Boolean(embeddedImageForExercise(name) || remotePoseUrls(name) || remoteSingleUrl(name));
  }

  function visualSources(name) {
    const embedded = embeddedImageForExercise(name);
    if (embedded) return [embedded];
    const poses = remotePoseUrls(name);
    if (poses) return poses;
    const single = remoteSingleUrl(name);
  ...
  credits.innerHTML = 'Ilustraciones adicionales: <a href="https://repdb.co" target="_blank" rel="noopener noreferrer">Exercise data by RepDB</a>.';
  els.library.appendChild(credits);
